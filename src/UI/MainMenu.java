...
//                centerX, startY, new InputAction("start", e -> startGame()));
//
//        Button settingsButton = new Button("Settings", buttonWidth, buttonHeight,
//                centerX, startY + 70, new InputAction("settings", e -> openSettings()));
//
//        Button exitButton = new Button("Exit", buttonWidth, buttonHeight,
//                centerX, startY + 140, new InputAction("exit", e -> exitGame()));
//
//
